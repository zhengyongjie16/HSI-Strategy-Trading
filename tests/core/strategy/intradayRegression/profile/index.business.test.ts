...
import { compileIndicatorUsageProfile } from '../../../../../src/core/strategy/intradayRegression/profile/index.js';
import type { SignalConfigSet } from '../../../../../src/core/strategy/intradayRegression/types.js';
...
describe('indicators/profile business flow', () => {
  it('compiles indicator profile with exact strategy and verification indicators', () => {
    const signalConfig: SignalConfigSet = {
      ...
      buyput: { conditionGroups: [] },
      sellput: { conditionGroups: [] },
    };
