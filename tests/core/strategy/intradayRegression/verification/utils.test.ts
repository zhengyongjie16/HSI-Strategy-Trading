/**
 * VerificationSampleStore 私有验证工具测试
 *
 * 覆盖：
...
import type { VerificationSampleEntry } from '../../../../../src/core/strategy/intradayRegression/verification/types.js';
import {
  createSampleQueue,
  findClosestEntry,
  projectVerificationSampleValues,
  pushToQueue,
} from '../../../../../src/core/strategy/intradayRegression/verification/utils.js';

function createEntry(timestamp: number, value: number): VerificationSampleEntry {
  return {
    timestamp,
    values: {
      K: {
...
describe('VerificationSampleStore utils', () => {
