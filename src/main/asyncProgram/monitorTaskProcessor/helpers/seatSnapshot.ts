...
export async function validateSeatSnapshotsAfterRefresh({
  baseInstrumentSymbol: _baseInstrumentSymbol,
  context,
  longSnapshot,
  shortSnapshot,
  refreshGate,
  ...
  const hasLongSnapshot = isSeatSnapshotValid(_baseInstrumentSymbol, 'LONG', longSnapshot, context);
  const hasShortSnapshot = isSeatSnapshotValid(
    _baseInstrumentSymbol,
    'SHORT',
    shortSnapshot,
    context,
  );
  ...
  const longValid = isSeatSnapshotValid(_baseInstrumentSymbol, 'LONG', longSnapshot, context);
  const shortValid = isSeatSnapshotValid(_baseInstrumentSymbol, 'SHORT', shortSnapshot, context);
